    ...
    getBlogAgent = () =>(
        ...
        <div style={{padding:'20px' ,overflow:'auto'}} className='code-container-one-home'>
            <code className='codefont'>
                <span className='codefont'><span style={{color:"blue"}}>import</span> os</span><br/>
                <span className='codefont'>os.environ[<span style={{color:'red'}}>'OPENAI_API_KEY'</span>] = <span style={{color:'red'}}>"YOUR_API_KEY"</span></span><br/>
            </code>
        </div>
        <h3 style={{paddingLeft:'10px'}}>Step 2: Import Dependencies</h3>
        <div className='code-container-one-home'>
            <code className='codefont'>
                <span className='code-line-number-code codefont'><span style={{color:"blue"}}>from</span> wyge.models.openai <span style={{color:"blue"}}> import</span> ChatOpenAi</span><br/>
                <span className='code-line-number-code codefont'><span style={{color:'blue'}}>from</span> wyge.tools.prebuilt_tools<span style={{color:'blue'}}> import</span> extract_relevant_sections_from_website, generate_images_and_add_to_blog</span><br/>
            </code>
        </div>
        <h3 style={{paddingLeft:'10px'}}>Step 3: Initialize Tools</h3>
        <div className='code-container-one-home'>
            <code className='codefont'>
                <span className='code-line-number-code codefont'>web_tool = extract_relevant_sections_from_website() <span className='code-line-number-comment'># Tool to scrap a website</span></span><br/>
                <span className='code-line-number-code codefont'>blog_tool = generate_images_and_add_to_blog() <span className='code-line-number-comment'> #Tool to generate image and add to blog</span></span>
            </code>
        </div>
        <h3 style={{paddingLeft:'10px'}}>Step 4: Initialize LLM with Tools</h3>
        <div className='code-container-one-home'>
            <code className='codefont'>
                <span className='code-line-number-code codefont'>llm = ChatOpenAI(tools = [blog_tool, web_tool], return_tool_output = True, memory=True)</span>
            </code>
        </div>
        ...
        <div className='code-container-one-home'>
            <code className='codefont'>
                ...
                <span className='code-line-number-code codefont'>context = llm.run(prompt1)</span>
            </code>
        </div>
        <h2 style={{paddingLeft:'10px'}}>Step 6: Generate Blog Post</h2>
        <div className='code-container-one-home' style={{padding:'10px'}}>
            <code className='codefont'>
                <span className='code-line-number-code codefont'>prompt2 = (</span>
                <span className='code-line-number-code codefont' style={{color:'red'}}>"Write a comprehensive blog post with images for a company based on the following details:"<span style={{color:'blue'}}>\n\n</span></span><br/>
                <span className='code-line-number-code codefont'>f<span style={{color:'red'}}>"Topic:</span>{'{topic}'}\n"</span>
                <span className='code-line-number-code codefont'>f<span>Summarized content from company's website:{'{context}'}\n\n"</span></span><br/>
                <span className='code-line-number-code codefont' style={{color:'red'}}>"The blog should include an engaging introduction to the topic,followed by detailed sections about how the company addresses the topic, "</span><br/>
                <span className='code-line-number-code codefont' style={{color:'red'}}>"and a conclusion summarizing the key points. Generate '{'<image>'} image prompt here {'</image>'}' where necessary."</span><br/>
                <span className='code-line-number-code codefont'>)</span><br/>
                <span className='code-line-number-code codefont'> blog_content = llm.run(prompt2)</span>
            </code>
        </div>
        </div>
    )
    ...
    getLinkedin = () =>(
        <div style={{padding:'10px' , width:'70%'}}>
            ...
            <div className='code-container-one-home' style={{overflow:'auto' , padding:'10px'}}>
                <code className='codefont'>
                    <span className='code-line-number-code codefont'><span style={{color:"red"}}>import</span> os</span><br/>
                    <span className='code-line-number-code codefont'>os.environ[<span style={{color:'red'}}>'OPENAI_API_KEY'</span>] = <span style={{color:'red'}}>"YOUR_API_KEY"</span></span><br/>
                </code>
            </div>
            <h3 style={{paddingLeft:'10px'}}>Step 2: Import Dependencies</h3>
            <div className='code-container-one-home' style={{overflow:'auto' , padding:'10px'}}>
                <code className='codefont'>
                    <span className='code-line-number-code codefont'><span style={{color:"red"}}>from</span> wyge.models.openai <span style={{color:"red"}}>import</span> ChatOpenAi</span><br/>
                    <span className='code-line-number-code codefont'><span style={{color:'red'}}>from</span> wyge.tools.prebuilt_tools<span style={{color:'red'}}>import</span> extract_relevant_sections_from_website, generate_images_and_add_to_blog</span><br/>
                </code>
            </div>
            <h3 style={{paddingLeft:'10px'}}>Step 3: Initialize Tools</h3>
            <div className='code-container-one-home' style={{overflow:'auto' , padding:'10px'}}>
                <code className='codefont'>
                    <span className='code-line-number-code codefont'>web_tool = extract_relevant_sections_from_website() <span># Tool to scrap a website</span></span><br/>
                    <span className='code-line-number-code codefont'>blog_tool = generate_images_and_add_to_blog() <span> #Tool to generate image and add to blog</span></span>
                </code>
            </div>
            <h3 style={{paddingLeft:'10px'}}>Step 4: Initialize LLM with Tools</h3>
            <div className='code-container-one-home' style={{overflow:'auto' , padding:'10px'}}>
            ...
            <div className='code-container-one-home' style={{overflow:'auto' , padding:'10px'}}>
                <code className='codefont'>
                    <span className='code-line-number-code codefont'>topic = <span>"How to tackle AI"</span></span><br/>
                    <span className='code-line-number-code codefont'>url = <span style={{color:'red'}}>""https://www.digiotai.com""</span></span><br/>
                    <span></span><br/>
                    <span className='code-line-number-code codefont'># Collect content from website</span>
                    <span className='code-line-number-code codefont'>prompt1 = (</span><br/>
                    <span className='code-line-number-code codefont'>f<span style={{color:'red'}}>"Gather relevant information about the topic from the website."</span>\n</span>
                    <span className='code-line-number-code codefont'>f"Topic:{'{topic}'}\n"</span><br/>
                    <span className='code-line-number-code codefont'>f"Website:{'{url}}'}\n"</span><br/>
            ...
            <div className='code-container-one-home' style={{overflow:'auto' , padding:'10px'}}>
                <code className='codefont'>
                    ...
                    <span className='code-line-number-code codefont'>f<span>Summarized content from company's website:{'{context}'}\n\n"</span></span><br/>
                    <span className='code-line-number-code codefont' style={{color:'red'}}>"The blog should include an engaging introduction to the topic,followed by detailed sections about how the company addresses the topic, "</span><br/>
                    <span className='code-line-number-code codefont' style={{color:'red'}}>"and a conclusion summarizing the key points. Generate '{'<image>'} image prompt here {'</image>'}' where necessary."</span>
                    <span className='code-line-number-code codefont'>)</span><br/>
                    <span className='code-line-number-code codefont'>blog_content = llm.run(prompt2)</span>
                </code>
            </div>
        ...
        <div style={{padding:'10px' , width:'70%'}}>
            ...
            <pre tabIndex='0' className='coding-element-home code-container-one-home'>
                <code className="codefont">
                    <span className='code-line-home codefont'>
                        ...
                        <span className='code-line-number-code codefont'><span style={{color:'blue'}}>import </span> pandas <span style={{color:'red'}}>as </span>pd</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                    ...
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># File path to the Excel file</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>file_path = <span  style={{color:'red'}}>"sample_data.xlsx"</span></span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># Load the dataset</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>data = pd.read_excel(file_path)</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># Take a sample of the last 50 rows</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>sample_data = data.tail(50)</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'></span>
                    ...
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># Convert the sample data into a CSV-like string format</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>sample_str = sample_data.to_csv(index=false, header=False)</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'></span>
                    ...
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'># Initialize the OpenAI model</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>llm = ChatOpenAI(memory=True, api_key = <span style={{color:'red'}}>"your-api-key-here"</span>)</span>
                    </span>
                </code>
            </pre>
            ...
            <pre tabIndex='0' className='coding-element-home code-container-one-home'>
                <code className='codefont'>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># Number of rows to generate in each chunk</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>chunk_size = 50</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># Total number of rows to generate</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>num_rows = 50</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># System message to instruct the odel to behave as a synthetic data generator</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>system_message = <span style={{color:'red'}}>"You are a synthetic data generator. Provide output in the specified format without extra text."</span></span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'></span>
                    ...
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># Store the generated data</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>generated_rows = []</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'>rows_generated = 0</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'>#Main loop to generate synthetic data until the desired number of rows is reached </span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-code codefont'><span style={{color:'red'}}>while</span>rows_generated {'<'} num_rows:</span>
                    </span>
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'># Use previously generated rows or the original smaple for generation</span>
                    </span>
                    <span className='code-line-home codefont'>
                    ...
                    <span className='code-line-home codefont'>
                        <span className='code-line-number codefont'></span>
                        <span className='code-line-number-comment codefont'><span style={{color:'red'}}>print</span>(generated_df.head())</span>
                    </span>
                </code>
            </pre>
        </div>
